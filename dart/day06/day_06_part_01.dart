#!/usr/bin/env -S dart
//
// @file day_06_part_01.dart
// @brief Advent of Code (AOC) 2022 Puzzle solution for:  Day 06 Part 01.
//
...
void main(List<String> arguments) async {
  ...
  for (String line in lines) {
    ...
    answer = getCharacterMarkerPosition(line, 4);
    stdout.writeln("Start-of-message marker at: $answer");
  }

  // Test data answer:    7;5;6;10;11.
  // Puzzle data answer:  1235
  stdout.writeln("""

 >>  Advent of Code: Day 06 Part 1  <<
     -> Characters processed before the 1st start-of-packet marker was detected : '$answer'
""");
}
